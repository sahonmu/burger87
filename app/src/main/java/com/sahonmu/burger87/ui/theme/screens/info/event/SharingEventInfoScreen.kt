package com.sahonmu.burger87.ui.theme.screens.info.event
...
@Composable
fun SharingEventInfoScreenPreview() {
    SharingEventInfoScreen(rememberNavController())
}


@Composable
fun SharingEventInfoScreen(
